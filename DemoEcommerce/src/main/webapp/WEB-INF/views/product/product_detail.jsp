	...
	<div class="flex-w flex-sb">
				...
				<div class="slick3">
					<c:forEach items="${listImage}" var="image">
						<div class="item-slick3"
							data-thumb="${pageContext.request.contextPath}/${image.image}">
		...
		<c:forEach items="${listVo}" var="vo">
			<div class="w-size14 p-t-30 respon5">
				<h4 class="product-detail-name m-text16 p-b-13">${vo.productName }</h4>

				<span class="m-text17"> ${vo.price } </span>
				...
				<div class="p-b-45">
					<span class="s-text8 m-r-35">CODE: ${vo.productCode }</span> <span
						class="s-text8">Categories: ${vo.categoryName }</span>
				</div>
				...
				<div
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">${vo.description }</p>
					</div>
				</div>
				...
				<div class="wrap-dropdown-content bo7 p-t-15 p-b-14">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">${vo.information }</p>
					</div>
				</div>
...
<section class="relateproduct bgwhite p-t-45 p-b-138">
	<div class="container">
		...
		<div class="wrap-slick2">
			<div class="slick2">
				<c:forEach items="${listProductVo}" var="product">
					<div class="item-slick2 p-l-15 p-r-15">
						...
						<div class="block2">
							...
							<div class="block2-txt p-t-20">
								<a
									href="${pageContext.request.contextPath}/product/${product.productName}/${product.productId}"
									class="block2-name dis-block s-text3 p-b-5">
									${product.productName } </a> <span
